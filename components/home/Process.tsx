...
export function Process() {
  ...
  return <section ref={ref} id="process" className="process-section wrapper" aria-labelledby="process-heading">
    ...
    <div className="section-title-row"><Reveal><h2 id="process-heading" className="editorial-heading">Great spaces start<br />with <em>a conversation.</em></h2></Reveal><p className="process-intro">A clear process. An open dialogue.<br />And you, at the centre of it all.</p></div>
