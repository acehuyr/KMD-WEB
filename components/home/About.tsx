...
export function About() {
  return (
    <section id="studio" className="studio-section wrapper" aria-labelledby="studio-heading">
      ...
      <Reveal><h2 id="studio-heading" className="studio-statement">Good design is felt.<br /><span>In the details. In the everyday.</span><br />In the way you <em>feel at home.</em></h2></Reveal>
      <div className="studio-bottom">
        ...
        <div className="studio-aside"><span className="studio-number">11<span>+</span></span><span className="micro-label">Years of<br />considered craft</span></div>
      </div>
    </section>
  );
}
